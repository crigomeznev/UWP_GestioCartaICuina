...
namespace GestioCarta.View
{
    public class ByteArrayToBitmapImageConverter : IValueConverter
    {
        ...
        {
            var task = ConvertAsync(value, targetType, parameter, language);

            //var result = AsyncContext.RunTask(MyAsyncMethod).Result;

            //var result = task.Wait();
            //var result = task.WaitAndUnwrapException();
            //BitmapImage image = ConvertAsync(value, targetType, parameter, language);
            //return image;


            //Task<object> taskImage = ConvertAsync(value, targetType, parameter, language);
            //taskImage.Start();

            //BitmapImage image = (BitmapImage)taskImage.Result;
